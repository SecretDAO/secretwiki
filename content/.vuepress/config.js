  ...
  themeConfig: {
    ...
    sidebar: [
      ...
      },
      {
        ...
        collapsable: false,
        children: [
          '/secretnodes/ui-components',
          '/secretnodes/ui-layout',
          '/secretnodes/frameworks',
          '/secretnodes/ui-utilities',
          '/secretnodes/utilities',
          '/secretnodes/integrations',
          '/secretnodes/dev-tools',
          '/secretnodes/scaffold',
          '/secretnodes/runtime',
          '/secretnodes/prerendering',
        ],
      },
    ]
  }
